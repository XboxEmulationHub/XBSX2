...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/XboxEmulationHub/XBSX2/windows_build_uwp.yml)
...
You can find the compilation instructions here: [BUILD.md](https://github.com/XboxEmulationHub/XBSX2/blob/master/pcsx2-uwp/BUILD.md)
...
* [Rockso85](https://github.com/Rockso85)/[redhood1337](https://github.com/redhood1337)/[fffathur](https://github.com/fffathur) – For help with the Assets.
